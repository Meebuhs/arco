...
## 0.8.2 - 2020-08-05
### Added
 - Added github icon to sidebar link

### Fixed
 - Fixed favicon not appearing on some pages
 - Fixed post width for some landscape screen sizes

## 0.8.1 - 2020-08-05
### Added
 - Added display of tags to top of post

### Changed
 - Removed completed and ongoing categories to allow the user to define their own categories

## 0.8.0 - 2020-07-15
### Added
 - Added site tagline to landing page and sidebar

### Fixed
 - Fixed project descriptions on post list
 - Fixed images being clickable past their boundaries
 - Fixed some image formatting
